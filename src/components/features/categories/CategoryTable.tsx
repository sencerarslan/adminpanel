...
import { useCategories, useDeleteCategory, useBulkDeleteCategories } from '@/hooks/useCategories';
...
export function CategoryTable(): React.JSX.Element {
    ...
    const { data, isLoading } = useCategories({ page, perPage, search });
    ...
    return (
        <>
            <DataTable
                columns={categoryColumns((id) => setDeleteId(id))}
                data={data?.data || []}
                isLoading={isLoading}
