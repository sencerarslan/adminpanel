        ...
        <div className="w-full max-w-md">
            <div className="rounded-xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-sm">
                ...
                <div className="mb-8 flex flex-col items-center gap-4">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-lg shadow-primary/25">
                        <Shield className="h-7 w-7 text-dark" aria-hidden="true" />
                    </div>
                ...
                <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="space-y-4" noValidate>
                    ...
                    <button
                        ...
                        className={cn(
                            'w-full rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-white-foreground',
